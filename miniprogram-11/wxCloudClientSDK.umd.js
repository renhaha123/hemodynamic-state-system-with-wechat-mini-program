(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  /** 鑾峰彇鐢ㄦ埛UA, 灏忕▼搴忎腑浣跨敤 getSystemInfo 鏇夸唬 */
  ...
  // 浣跨敤 TypeScript 鐨� Proxy 鏉ュ畾涔変竴涓姩鎬佺殑瀹㈡埛绔�
      ...
      return new Proxy({}, {
          get: function (target, prop) {
              if (typeof prop === 'string') {
                  ...
                  // 杩斿洖涓€涓嚱鏁帮紝杩欎釜鍑芥暟鎺ュ彈浠绘剰鍙傛暟骞惰繑鍥炰竴涓� Promise
